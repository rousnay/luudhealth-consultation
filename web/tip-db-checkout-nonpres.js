...
const OrderNonPresSubmit = async (webhookResponse) => {
  ...
  if (product_id) {
    const data_order_nonpres = DB.collection("data_order_nonpres");
    ...
    const result = await data_order_nonpres.insertOne({
